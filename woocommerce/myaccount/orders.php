...
<?php if ( $has_orders ) : ?>
	...
	<table class="custom-order-summary woocommerce-orders-table woocommerce-MyAccount-orders shop_table shop_table_responsive my_account_orders account-orders-table">
		<thead>
			<tr>
