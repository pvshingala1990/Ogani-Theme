		...
		if ($wishlist && $wishlist->has_items()) :
						...
						<?php if ($show_remove_product) : ?>
							<td class="product-remove">
								<div>
									 ...
									 */
									?>
									<a href="<?php echo esc_url($item->get_remove_url()); ?>" class="remove remove_from_wishlist" title="<?php echo esc_html(apply_filters('yith_wcwl_remove_product_wishlist_message_title', __('Remove this product', 'yith-woocommerce-wishlist'))); ?>"><span class="icon_close"></span></a>
								</div>
							</td>
						<?php endif; ?>
			...
			<tr>
				...
				<td colspan="<?php echo esc_attr($column_count); ?>" class="wishlist-empty">
					...
					<a href="<?php echo esc_url(get_permalink(wc_get_page_id('shop'))); ?>" class="site-btn">Return to shop</a>
				</td>
			</tr>
		<?php
		endif;
